namespace ReentrantAsyncLock
{
    ...
    sealed class AsyncDisposable : IAsyncDisposable
    {
        ...
        /// <remarks>
        /// <para>
        /// You can call <see cref="DisposeAsync"/> on the returned object as many times as you like and the given
        /// delegate will only be invoked up to once.
        /// </para>
        /// </remarks>
        public static AsyncDisposable Create(Func<ValueTask> disposeAsync) => new AsyncDisposable(disposeAsync);
